...
public class RenderWindTurbine extends RenderCustomBlock
{
    ...
    public RenderWindTurbine(Block var1)
    {
        super(var1);
    }
    ...
    {
        TileWindTurbine var7 = (TileWindTurbine)CoreLib.getTileEntity(var2, var3, var4, var5, TileWindTurbine.class);
        ...
        if (var7 != null)
        {
            ...
            this.context.setTex(150, 158, 157, 157, 156, 156);
