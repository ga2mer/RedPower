...
public class RenderBatteryBox extends RenderCustomBlock
{
    ...
    public RenderBatteryBox(Block var1)
    {
        super(var1);
    }
    ...
    {
        TileBatteryBox var7 = (TileBatteryBox)CoreLib.getTileEntity(var2, var3, var4, var5, TileBatteryBox.class);
        ...
        if (var7 != null)
        {
            ...
            int var8 = 129 + var7.getStorageForRender();
            this.context.setTex(84, 128, var8, var8, var8, var8);
    ...
    public void renderInvBlock(RenderBlocks var1, int var2)
    {
        ...
        this.context.setTex(84, 128, 129, 129, 129, 129);
