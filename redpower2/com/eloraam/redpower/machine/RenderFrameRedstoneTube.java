...
{
    public RenderFrameRedstoneTube(Block var1)
    {
        super(var1);
    }
    ...
    {
        boolean var7 = false;
        TileFrameRedstoneTube var8 = (TileFrameRedstoneTube)CoreLib.getTileEntity(var2, var3, var4, var5, TileFrameRedstoneTube.class);
        ...
        if (var8 != null)
        {
            ...
            int var13 = TubeLib.getConnections(var2, var3, var4, var5) | var8.getConnectionMask() >> 24;
            ...
            var10 = (var8.PowerState + 84) / 85;
            this.renderCenterBlock(var13, 68 + var10, 72 + var10);

            if (var8.paintColor > 0)
            {
                var11 = this.paintColors[var8.paintColor - 1];
                this.context.setTint((float)(var11 >> 16) / 255.0F, (float)(var11 >> 8 & 255) / 255.0F, (float)(var11 & 255) / 255.0F);
