...
public class RenderMotor extends RenderCustomBlock
{
    ...
    {
        TileMotor var7 = (TileMotor)CoreLib.getTileEntity(var2, var3, var4, var5, TileMotor.class);
        ...
        if (var7 != null)
        {
            ...
            if (var7.Active)
            {
                this.context.setTex(150, 255, 239, 239, 155, 155);
            }
            else
            {
                int var8 = 144 + (var7.Charged ? 1 : 0);
                this.context.setTex(150, 151, var8, var8, 155, 155);
            }

            this.context.setSize(0.0D, 0.0D, 0.0D, 1.0D, 1.0D, 1.0D);
            this.context.setupBox();
            this.context.transform();
            this.context.orientTextureNew(var7.Rotation);
    ...
    public void renderInvBlock(RenderBlocks var1, int var2)
    {
        ...
        this.context.setTex(150, 151, 144, 144, 155, 155);
